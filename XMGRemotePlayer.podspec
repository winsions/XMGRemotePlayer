...
"播放器呀播放器想嘻嘻嘻嘻嘻嘻嘻嘻嘻"
  ...
  s.homepage         = 'https://coding.net/u/seemygo_wangshunzi/p/XMGFMRemotePlayer'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wangshunzi' => '123@qq.com' }
  s.source           = { :git => 'https://git.coding.net/seemygo_wangshunzi/XMGFMRemotePlayer.git', :tag => s.version.to_s }
